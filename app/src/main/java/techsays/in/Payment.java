...
ammount=findViewById(R.id.paymentammount);
        back=findViewById(R.id.payback);

back.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {

        final Intent pay1 = new Intent(Payment.this, Home.class);
        ...
        discription=findViewById(R.id.paymentdiscriptin);
...
if(ammount.getText().toString().isEmpty()){
    ...
    ammount.setError("Enter Ammount");
               ...
               else if(discription.getText().toString().isEmpty()){

                    discription.setError("Enter Discription");
                }

else {
    payUsingUpi(user.getDisplayName(),"anoopsuvarnan1@okaxis",discription.getText().toString(),ammount.getText().toString());
